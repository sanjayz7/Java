...
What Methods Can Be Accessed?

When using:

Animal myDog = new Dog();

you can access only methods defined in Animal.

Example:

myDog.makeSound();

works because makeSound() exists in Animal.
...
Because reference type is Animal.

Java checks methods using the reference type.
